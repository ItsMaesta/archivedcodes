...
class AFK extends Command {
    ...
    async run(message, args, data) {
        ...
        if (message.content.includes("@here") || message.content.includes("@everyone") || message.content.includes("<@&352403373712080897>") || message.content.includes("352403373712080897")) return
        message.member.setNickname("[AFK] " + message.member.displayName)
        message.reply("AFK moduna girdin! Bir şey yazana kadar AFK sayılacaksın!").then(msg => { msg.delete({ timeout: 7000 }) })
